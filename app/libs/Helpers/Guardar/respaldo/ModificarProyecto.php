...
require_once (APP_PATH . 'models/DAOProyecto.php');
...
Class Guardar_Proyecto{
    ...
    public function __construct($parametros) {
        $this->_DAOProyecto = New DAOProyecto();
    ...
    public function guardar(){
        ...
        $id_proyecto = $this->_parametros["id_proyecto"];
        ...
        $data = array("gl_nombre_proyecto"       => $this->_parametros["nombre_proyecto"],
                      "gl_descripcion_proyecto"   => $this->_parametros["descripcion"],
                      "gl_cliente"   => $this->_parametros["cliente"]);
        
        $resultado = $this->_DAOProyecto->getProyectoById($id_proyecto);
        if(!is_null($resultado)){      
            $this->_DAOProyecto->update($data, $id_proyecto, $campo_id);
        }
    }
