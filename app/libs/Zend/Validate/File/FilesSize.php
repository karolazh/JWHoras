...
class Zend_Validate_File_FilesSize extends Zend_Validate_File_Size
{
    ...
    protected $_messageTemplates = array(
        self::TOO_BIG      => "El archivo debe tener un tamaño maximo de '%max%', pero tiene '%size%'.",
        self::TOO_SMALL    => "El archivo debe tener un tamaño minimo de '%min%', pero tiene '%size%'.",
        self::NOT_READABLE => "El archivo no puede ser leido",
    );
