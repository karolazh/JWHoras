...
class Zend_Validate_File_Extension extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::FALSE_EXTENSION => "El archivo '%value%' tiene una extensi&oacute;n inv&aacute;lida",
        self::NOT_FOUND       => "El archivo '%value%' no tiene permisos de lectura o no existe",
    );
