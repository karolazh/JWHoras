...
class Zend_Validate_File_MimeType extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::FALSE_TYPE   => "El archivo '%value%' tiene un tipo inv&aacute;lido '%type%'",
        self::NOT_DETECTED => "El mimetype del archivo '%value%' no puede ser detectado",
        self::NOT_READABLE => "El archivo '%value%' no tiene permisos de lectura o no existe",
    );
