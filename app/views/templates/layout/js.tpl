<footer>
    ...
    <script type="text/javascript" src="{$static}js/plugins/DataTables/extensions/Buttons/js/dataTables.buttons.min.js"></script>
    <script type="text/javascript" src="{$static}js/plugins/DataTables/plugins/JSZip/jszip.min.js"></script>
    <script type="text/javascript" src="{$static}js/plugins/DataTables/plugins/buttons/buttons.html5.min.js"></script>
    <script type="text/javascript" src="{$static}js/plugins/DataTables/plugins/pdfmake/pdfmake.min.js"></script>
    <script type="text/javascript" src="{$static}js/plugins/DataTables/plugins/pdfmake/vfs_fonts.js"></script>
