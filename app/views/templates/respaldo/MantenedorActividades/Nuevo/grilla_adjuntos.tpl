        ...
        {foreach from=$adjuntos item=item}
            <tr>
                ...
                <td class="text-center" style="width:100px;">
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-danger btn-flat" onclick="MantenedorActividades.borrarAdjunto({$item.indice});" title="ELIMINAR ARCHIVO ACTIVIDAD"><i class="fa fa-remove"></i></button>
                        <!--
