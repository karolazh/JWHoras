            ...
            {foreach $arrExamenes as $exa}
                <tr>
                    ...
                    <td align="center">
                        ...
                        {elseif $exa->resultado == "A"}
                            <h6><b><span class="label label-danger small">ALTERADO</span></b></h6>
                        {else}
                            <h6><b><span class="label label-warning small">SIN INFORMACI&Oacute;N</span></b></h6>
                        {/if}
                    </td>
                    {*<td class="text-center" style="width:100px;">
                        <div class="btn-group">
