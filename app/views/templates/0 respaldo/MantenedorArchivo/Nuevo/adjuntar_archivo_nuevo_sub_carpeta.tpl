    ...
    <div class="box box-success">
        <div class="box-body">
            <form class="form" role="form" enctype="multipart/form-data" method="post"
                  action="{$smarty.const.BASE_URI}/MantenedorArchivos/subirArchivoNuevosubcarpeta">
                <div class="form-group">
                    <label class="control-label">Busque el nuevo archivo a adjuntar a la sub carpeta </label>
                   <div class="">
