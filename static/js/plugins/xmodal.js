...
var xModal = {
    ...
    progress_bar : '<div class="text-center"><i class="fa fa-spin fa-spinner fa-4x"></i></div>',
							  ...
							  '<div class="modal-dialog '+size+' modal-lg-xs" style="margin-top:10px; '+widthModal+'">'+
							    '<div class="modal-content" >'+
							      '<div class="modal-header">'+
								     ...
								     titulo+
	      							'</div>'+
							      '<div class="modal-body" style="overflow:hidden;background-color:#ECF0F5;"><div id="progress">'+xModal.progress_bar+'</div> <div id="content-modal" style="display:none">'+
							      content+
							    '</div></div>'+
							    footer+
							    '</div>'+
